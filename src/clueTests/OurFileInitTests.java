...
public class OurFileInitTests {
	...
	public void testRoomInitials() {
		...
		assertEquals('R', board.getCellAt(4, 7).getInitial());
		assertEquals('B', board.getCellAt(8, 2).getInitial());
		assertEquals('O', board.getCellAt(18, 17).getInitial());
		assertEquals('K', board.getCellAt(20, 3).getInitial());
	}
	...
	public void testBadColumns() throws BadConfigFormatException, FileNotFoundException {
		...
		Board board = new Board("ClueFiles/ClueLayoutBadColumns.csv", "ClueFiles/ClueLegend.txt");
	...
	public void testBadRoom() throws BadConfigFormatException, FileNotFoundException {
		Board board = new Board("ClueFiles/ClueLayoutBadRoom.csv", "ClueFiles/ClueLegend.txt");
		board.loadRoomConfig();
		board.loadBoardConfig();
	}
